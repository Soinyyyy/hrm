...
public class ValidatorUtils {
    /**
     * 对一些邮箱手机号
     * 公司信用码的格式判断是否正确如果正确返回true
     * 如果不正确返回false
     */
    public static final String SLICE18 = "^([159Y]{1})([1239]{1})([0-9ABCDEFGHJKLMNPQRTUWXY]{6})([0-9ABCDEFGHJKLMNPQRTUWXY]{9})([0-90-9ABCDEFGHJKLMNPQRTUWXY])$";
    ...
    public static void main(String[] args) {
        System.out.println(isLicense15("110108000000016"));
    }
    /**
     * 营业执照 统一社会信用代码（15位）
     * @param license
