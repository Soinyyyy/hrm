...
public class BaseConstant {
    ...
    public class CourseConstant {
        ...
        //课程相关交换机
        public static final String EXCHANGE_TOPICS_COURSE = "exchange_topics_course";
        public static final String QUEUE_COURSE_EMAIL = "queue_course_email";
        public static final String QUEUE_COURSE_SMS = "queue_course_sms";
        //站内信
        public static final String QUEUE_COURSE_STATION_MESSAGE = "queue_course_station_message";
    }
}